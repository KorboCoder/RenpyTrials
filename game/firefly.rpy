init python:
    ...
    class FireflyFactory(object):
        ...
        def create(self, particles, st):
            ...
            for _i in xrange(0, self.max_particles):
                ...
                rv.append( FireflyParticle(self.image[depth-1],      # the image used by the particle
    ...
    class FireflyParticle(object):
        def __init__(self, image, wind, speed, direction, xborder, yborder):

            """
            Initializes the Firefly particle. This is called automatically when the object is created.
            """
            
            # The image used by this particle
            self.image = image
            
            # For safety (and since we don't have Firefly going from the floor to the sky o.o)
